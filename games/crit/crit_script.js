...
class CRITGui {  
  ...
  constructor() {  
    ...
    const partitionTypeSelectEl = document.getElementById("partition-type-select");
    if (partitionTypeSelectEl) {
      partitionTypeSelectEl.onchange = ()=>this.updatePartitionUI();
